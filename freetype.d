...
//alias const int FT_Render_Mode_;
...
alias ulong function(FT_Stream, c_ulong, ubyte*, c_ulong) FT_Stream_IoFunc;
...
alias FT_Face_InternalRec_ FT_Face_InternalRec;
...
alias FT_ServiceCacheRec_ FT_ServiceCacheRec;
alias FT_ServiceCacheRec_* FT_ServiceCache;

// Incrimental Interface
struct FT_Incremental_InterfaceRec_
{
	const FT_Incremental_FuncsRec* funcs;
	//FT_Incremental object;
};
alias FT_Incremental_InterfaceRec_ FT_Incremental_InterfaceRec;
alias FT_Incremental_InterfaceRec_* FT_Incremental_Interface;
